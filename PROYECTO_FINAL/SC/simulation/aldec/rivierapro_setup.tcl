...
# ACDS 17.0 595 win32 2019.08.01.01:32:28
# ----------------------------------------
...
# ----------------------------------------
# If SC is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/SC.vhd"
}
