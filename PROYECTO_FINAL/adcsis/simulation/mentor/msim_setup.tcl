...
# ----------------------------------------
# If adcsis is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 595 win32 2019.08.01.01:37:40
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/adcsis.vhd"
}
